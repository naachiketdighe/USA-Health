/**
 * Object that defines the attributes for visualization.
 * Each attribute has a label and color associated with it.
 * @type {Object}
 */
const attr = {
    poverty_perc: {
...
/**
 * Fetches the necessary data and initializes the visualizations.
 * @returns {Promise} A promise that resolves when the data is fetched and visualizations are initialized.
 */
Promise.all([
    ...
    /**
     * Updates the visualizations based on the selected attributes.
     * @param {Object} currentVis - The current visualization object.
     */
    updateVisualizations = (currentVis) => {
        ...
        if (currentVis != bar1) bar1.brushG.call(bar1.brush.move, null);
        if (currentVis != bar2) bar2.brushG.call(bar2.brush.move, null);
    ...
    bar1 = new Combinedchart(
        { parentElement: "#bar1" },
        attributeSelect1.value,
        1,
        "barchart"
    );
    bar2 = new Combinedchart(
        { parentElement: "#bar2" },
        attributeSelect2.value,
        2,
        "barchart"
