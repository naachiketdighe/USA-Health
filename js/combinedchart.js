// Define a class called Combinedchart
class Combinedchart {
    ...
    constructor(_config, _attributeName, _num, _chartType) {
        this.config = {
            ...
            margin: { top: 15, bottom: 45, right: 25, left: 45 },
        };
        this.attributeName = _attributeName;
        this.number = _num;
        this.chartType = _chartType; // 'barchart' or 'histogram'
        this.statusTypes = ["Rural", "Small City", "Suburban", "Urban"]; // Define statusTypes array
    ...
    updateVis() {
        ...
        if (vis.chartType === 'histogram') {
            ...
            const barWidth = vis.config.containerWidth / vis.statusTypes.length;
